...
process.stdin.on('data', function(chunk) {
    ...
    /* DONE 1: Wrote a function named 'loading' to log following message after 1 second on to console
        Loading score...
    */
    /**
     * Function to print the message 'Loading score...' on the console after 1 second
     */
    const loading = () => {
        setTimeout(() =>{
